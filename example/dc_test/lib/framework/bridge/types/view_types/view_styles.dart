...
class ViewBorder {
  ...
  Map<String, dynamic> toMap() {
    ...
    return {
      ...
      if (pattern != null) 'borderPattern': pattern,
...
class ViewStyle {
  ...
  Map<String, dynamic> toMap() {
    ...
    return {
      ...
      if (bounds != null) 'bounds': {'width': bounds!.width, 'height': bounds!.height},
      if (transform != null) ...transform!.toMap(),
      if (cornerRadius != null) 'cornerRadius': cornerRadius,
      if (maskedCorners != null) 'maskedCorners': maskedCorners!.map((c) => c.value).toList(),
