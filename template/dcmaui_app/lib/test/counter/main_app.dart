  ...
  VNode buildRender() {
    ...
    return DCSafeAreaView(
      ...
      children: [
        ...
        DCScrollView(
          style: DCScrollViewStyle(backgroundColor: Colors.amber, height: 200),
          onScroll: (v) => print(v),
        ),
        DCTextInput(
            autoCapitalize: 'none',
